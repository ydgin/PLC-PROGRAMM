...
// ========== ID ПОЛІВ З ВАШОЇ ФОРМИ ==========
// ⚠️ ЗАМІНІТЬ ЦІ ЗНАЧЕННЯ НА РЕАЛЬНІ ID З ВАШОЇ ФОРМИ!
// Як знайти ID: відкрийте форму → F12 → Ctrl+F → введіть "entry."
const FORM_FIELDS = {
    // Основна інформація
...
function sendToGoogleForm() {
    ...
    // ВСІ ПОЛЯ (текстові та випадаючі)
